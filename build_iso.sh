...
echo wget -O /tmp/cephadm/usr/local/bin/cephadm/SEAPATH_CLUSTER https://download.ceph.com/rpm-19.2.3/el9/noarch/cephadm
wget -O /tmp/cephadm/usr/local/bin/cephadm/SEAPATH_CLUSTER https://download.ceph.com/rpm-19.2.3/el9/noarch/cephadm
...
for i in quay.io/ceph/ceph:v19.2.3 docker.io/library/registry:2
do
